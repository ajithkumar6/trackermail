...
INSERT INTO userinfo (email,active,last_name,first_name,password,role) values('paypal.tcs@gmail.com',true,'ADMIN','Project','$2a$10$pNOQHgXFKcfrqzdgsPI2oOBJlXaGiAWQqh8fy2sAV9cOtpzfiyBf.','MANAGER');
